           ...
           <div className='flex flex-col gap-8 md:flex-row items-center justify-center w-full'>
            ...
            <div className='w-3/4 md:w-1/2'>
               <div className='w-full pt-8 md:pt-2'>
                 <p className='font-bold uppercase mb-8 text-lightColor text-lg text-center md:text-left'>Subscribe to our newsletter</p>
                 <form action="https://getform.io/f/axojjngb" method="POST" className='flex flex-col sm:flex-row'>
                   <input type='text' name='email' className='w-full p-2 mr-4 rounded-md mb-4'placeholder='Daily newsletter...'/>
                   <GreenBtn title='subscribe' type='submit'className='p-2 mb-4' />
