        ...
        <div className='flex flex-col items-center justify-center max-w-screen-xl mx-auto h-full px-3 py-12'>
            <div className='text-center'>
                <h2 className='text-5xl font-bold'>
                    By <span  className='text-lightColor'>Developers </span>
                    for{''} <span className='text-lightColor'>Developers</span>
                </h2>

                <p className='text-xl font-light text-gray-500 py-8'>
                  And cushions unhappy spoken hauntedtell front perched velvet or, 
                  one wore and there evermore the opened. Denser each books said doubting and visiter.
                  Silence ever that theeby stately. Expressing and betook again home raven nevermore.
                </p>
